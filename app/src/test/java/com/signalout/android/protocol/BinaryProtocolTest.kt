...
class BinaryProtocolTest {
     ...
     * anything it can't parse as a valid SignaloutPacket.
     */
    @Test
    ...
    fun `sender ID is padded or truncated to exactly 8 bytes`() {
        ...
        val shortPacket = SignaloutPacket(
            version = 1u,
        ...
        val longPacket = SignaloutPacket(
            version = 1u,
            type = MessageType.ANNOUNCE.value,
            senderID = longSender,
            timestamp = fixedTimestamp,
    ...
    private fun roundTrip(packet: SignaloutPacket): SignaloutPacket {
    ...
    private fun assertPacketEquals(expected: SignaloutPacket, actual: SignaloutPacket) {

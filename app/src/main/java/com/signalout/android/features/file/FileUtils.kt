package com.signalout.android.features.file
...
object FileUtils {
    ...
    fun saveIncomingFile(
        context: Context,
        file: com.signalout.android.model.SignaloutFilePacket
    ): String {
    ...
    /**
     * Classify SignaloutMessageType from MIME string used in file messages.
     */
    fun messageTypeForMime(mime: String): com.signalout.android.model.SignaloutMessageType {
        val lower = mime.lowercase()
        return when {
            lower.startsWith("image/") -> com.signalout.android.model.SignaloutMessageType.Image
            lower.startsWith("audio/") -> com.signalout.android.model.SignaloutMessageType.Audio
            else -> com.signalout.android.model.SignaloutMessageType.File
        }
    }

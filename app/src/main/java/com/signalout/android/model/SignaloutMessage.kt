...
@Parcelize
enum class SignaloutMessageType : Parcelable {
    Message,
    Audio,
    Image,
    File
...
/**
 * SignaloutMessage - 100% compatible with iOS version
 */
@Parcelize
data class SignaloutMessage(
    val id: String = UUID.randomUUID().toString().uppercase(),
    val sender: String,
    val content: String,
    val type: SignaloutMessageType = SignaloutMessageType.Message,
    val timestamp: Date,
    ...
    companion object {
         ...
         */
        fun fromBinaryPayload(data: ByteArray): SignaloutMessage? {
            try {
                ...
                return SignaloutMessage(
                    id = id,
                    sender = sender,
                    content = content,
                    type = SignaloutMessageType.Message,
                    timestamp = timestamp,
                    isRelay = isRelay,

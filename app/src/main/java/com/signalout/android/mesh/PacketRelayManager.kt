 ...
 * 
 * This class handles all relay decisions and logic for signalout packets.
...
class PacketRelayManager(private val myPeerID: String) {
    ...
    private fun isRelayEnabled(): Boolean = try {
        com.signalout.android.ui.debug.DebugSettingsManager.getInstance().packetRelayEnabled.value
     ...
     */
    internal fun isPacketAddressedToMe(packet: SignaloutPacket): Boolean {
     ...
     */
    private fun shouldRelayPacket(packet: SignaloutPacket, fromPeerID: String): Boolean {

...
import com.signalout.android.protocol.MessagePadding
import com.signalout.android.model.FragmentPayload
...
class FragmentManager {
    ...
    companion object {
        ...
        private const val FRAGMENT_SIZE_THRESHOLD = com.signalout.android.util.AppConstants.Fragmentation.FRAGMENT_SIZE_THRESHOLD // Matches iOS: if data.count > 512
        private const val MAX_FRAGMENT_SIZE = com.signalout.android.util.AppConstants.Fragmentation.MAX_FRAGMENT_SIZE        // Matches iOS: maxFragmentSize = 469 
        private const val FRAGMENT_TIMEOUT = com.signalout.android.util.AppConstants.Fragmentation.FRAGMENT_TIMEOUT_MS     // Matches iOS: 30 seconds cleanup
        private const val CLEANUP_INTERVAL = com.signalout.android.util.AppConstants.Fragmentation.CLEANUP_INTERVAL_MS     // 10 seconds cleanup check
    }
     ...
     */
    fun createFragments(packet: SignaloutPacket): List<SignaloutPacket> {
        try {
        ...
        val fragments = mutableListOf<SignaloutPacket>()
        ...
        for (index in fragmentChunks.indices) {
            ...
            val fragmentPacket = SignaloutPacket(
     ...
     */
    fun handleFragment(packet: SignaloutPacket): SignaloutPacket? {
        ...
        try {
            ...
            if (fragmentMap != null && fragmentMap.size == fragmentPayload.total) {
                ...
                val originalPacket = SignaloutPacket.fromBinaryData(reassembledData.toByteArray())
...
interface FragmentManagerDelegate {
    fun onPacketReassembled(packet: SignaloutPacket)
}

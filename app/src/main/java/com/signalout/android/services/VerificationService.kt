...
import com.signalout.android.util.dataFromHexString
...
object VerificationService {
    private const val CONTEXT = "signalout-verify-v1"
    private const val RESPONSE_CONTEXT = "signalout-verify-resp-v1"
    ...
    data class VerificationQR(
        ...
        companion object {
            fun fromUrlString(urlString: String): VerificationQR? {
                ...
                if (uri.scheme != "signalout" || uri.host != "verify") return null

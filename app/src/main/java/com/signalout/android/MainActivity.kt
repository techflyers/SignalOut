...
import com.signalout.android.onboarding.BluetoothCheckScreen
import com.signalout.android.onboarding.BluetoothStatus
import com.signalout.android.onboarding.BluetoothStatusManager
import com.signalout.android.onboarding.BatteryOptimizationManager
import com.signalout.android.onboarding.BatteryOptimizationPreferenceManager
import com.signalout.android.onboarding.BatteryOptimizationScreen
import com.signalout.android.onboarding.BatteryOptimizationStatus
import com.signalout.android.onboarding.BackgroundLocationPermissionScreen
import com.signalout.android.onboarding.InitializationErrorScreen
import com.signalout.android.onboarding.InitializingScreen
import com.signalout.android.onboarding.LocationCheckScreen
import com.signalout.android.onboarding.LocationStatus
import com.signalout.android.onboarding.LocationStatusManager
import com.signalout.android.onboarding.OnboardingCoordinator
...
import com.signalout.android.nostr.PoWPreferenceManager
...
class MainActivity : OrientationAwareActivity() {
    ...
    private val forceFinishReceiver = object : android.content.BroadcastReceiver() {
        override fun onReceive(context: android.content.Context, intent: android.content.Intent) {
            if (intent.action == com.signalout.android.util.AppConstants.UI.ACTION_FORCE_FINISH) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val filter = android.content.IntentFilter(com.signalout.android.util.AppConstants.UI.ACTION_FORCE_FINISH)
        if (android.os.Build.VERSION.SDK_INT >= 33) {
            registerReceiver(
                forceFinishReceiver,
                filter,
                com.signalout.android.util.AppConstants.UI.PERMISSION_FORCE_FINISH,
                null,
        ...
        com.signalout.android.service.AppShutdownCoordinator.cancelPendingShutdown()
        ...
        try { com.signalout.android.service.MeshForegroundService.start(applicationContext) } catch (_: Exception) { }
        meshService = com.signalout.android.service.MeshServiceHolder.getOrCreate(applicationContext)
                ...
                androidx.compose.foundation.layout.Box(modifier = Modifier.fillMaxSize()) {
                    ...
                    if (isCallActive) {
                        val isVideo = when (val state = callState) {
                            ...
                            is com.signalout.android.call.CallState.Connecting -> state.isVideo
                            is com.signalout.android.call.CallState.Connected -> state.isVideo
                            else -> false
                        }
                        
                        if (isVideo) {
                            com.signalout.android.ui.call.VideoCallScreen(callManager = callManager, callState = callState, onDismiss = { callManager.endCall() })
                        } else {
                            com.signalout.android.ui.call.VoiceCallScreen(callManager = callManager, callState = callState, onDismiss = { callManager.endCall() })
                        }
                    }
                }
            }
        ...
        lifecycleScope.launch {
            ...
            if (permissionManager.isFirstTimeLaunch()) {
                ...
                if (permissionManager.needsBackgroundLocationPermission() &&
                    ...
                    !com.signalout.android.onboarding.BackgroundLocationPreferenceManager.isSkipped(this@MainActivity)
                ) {
                    mainViewModel.updateOnboardingState(OnboardingState.BACKGROUND_LOCATION_EXPLANATION)
                } else {
    ...
    private fun initializeApp() {
        ...
        lifecycleScope.launch {
            try {
                ...
                com.signalout.android.nostr.LocationNotesInitializer.initialize(this@MainActivity)
    ...
    private fun handleNotificationIntent(intent: Intent) {
        val shouldOpenPrivateChat = intent.getBooleanExtra(
            com.signalout.android.ui.NotificationManager.EXTRA_OPEN_PRIVATE_CHAT, 
            false
        )
        
        val shouldOpenGeohashChat = intent.getBooleanExtra(
            com.signalout.android.ui.NotificationManager.EXTRA_OPEN_GEOHASH_CHAT,
            false
        )
        
        when {
            shouldOpenPrivateChat -> {
                val peerID = intent.getStringExtra(com.signalout.android.ui.NotificationManager.EXTRA_PEER_ID)
                val senderNickname = intent.getStringExtra(com.signalout.android.ui.NotificationManager.EXTRA_SENDER_NICKNAME)
            ...
            shouldOpenGeohashChat -> {
                val geohash = intent.getStringExtra(com.signalout.android.ui.NotificationManager.EXTRA_GEOHASH)
                ...
                if (geohash != null) {
                    ...
                    val level = when (geohash.length) {
                        7 -> com.signalout.android.geohash.GeohashChannelLevel.BLOCK
                        6 -> com.signalout.android.geohash.GeohashChannelLevel.NEIGHBORHOOD
                        5 -> com.signalout.android.geohash.GeohashChannelLevel.CITY
                        4 -> com.signalout.android.geohash.GeohashChannelLevel.PROVINCE
                        2 -> com.signalout.android.geohash.GeohashChannelLevel.REGION
                        else -> com.signalout.android.geohash.GeohashChannelLevel.CITY // Default fallback
                    }
                    val geohashChannel = com.signalout.android.geohash.GeohashChannel(level, geohash)
                    val channelId = com.signalout.android.geohash.ChannelID.Location(geohashChannel)
    ...
    private fun handleVerificationIntent(intent: Intent) {
        ...
        if (uri.scheme != "signalout" || uri.host != "verify") return

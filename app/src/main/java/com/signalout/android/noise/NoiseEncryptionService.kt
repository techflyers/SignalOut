package com.signalout.android.noise

import android.content.Context
import android.util.Log
import com.signalout.android.identity.SecureIdentityStateManager
import com.signalout.android.mesh.PeerFingerprintManager
...
class NoiseEncryptionService(private val context: Context) {
    ...
    companion object {
        ...
        private const val REKEY_TIME_LIMIT = com.signalout.android.util.AppConstants.Noise.REKEY_TIME_LIMIT_MS // 1 hour (same as iOS)
        private const val REKEY_MESSAGE_LIMIT = com.signalout.android.util.AppConstants.Noise.REKEY_MESSAGE_LIMIT_ENCRYPTION // 1k messages (matches iOS) (same as iOS)
    }
    ...
    private fun generateKeyPair(): Pair<ByteArray, ByteArray> {
        try {
            val dhState = com.signalout.android.noise.southernstorm.protocol.Noise.createDH("25519")
    ...
    /**
     * Sign a SignaloutPacket using our Ed25519 signing key
     */
    fun signPacket(packet: com.signalout.android.protocol.SignaloutPacket): com.signalout.android.protocol.SignaloutPacket? {
    ...
    /**
     * Verify a SignaloutPacket signature using the provided public key
     */
    fun verifyPacketSignature(packet: com.signalout.android.protocol.SignaloutPacket, publicKey: ByteArray): Boolean {

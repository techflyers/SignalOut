...
import com.signalout.android.MainActivity
...
class MeshForegroundService : Service() {
    ...
    companion object {
        private const val CHANNEL_ID = "signalout_mesh_service"
        private const val NOTIFICATION_ID = 10001

        const val ACTION_START = "com.signalout.android.service.START"
        const val ACTION_STOP = "com.signalout.android.service.STOP"
        const val ACTION_QUIT = "com.signalout.android.service.QUIT"
        const val ACTION_UPDATE_NOTIFICATION = "com.signalout.android.service.UPDATE_NOTIFICATION"
        const val ACTION_NOTIFICATION_PERMISSION_GRANTED = "com.signalout.android.action.NOTIFICATION_PERMISSION_GRANTED"
    ...
    private fun buildNotification(activePeers: Int): Notification {
        ...
        return NotificationCompat.Builder(this, CHANNEL_ID)
            ...
            .addAction(
                ...
                getString(R.string.notification_action_quit_signalout),
                quitPendingIntent
            )
            .build()
    }

...
import com.signalout.android.ui.media.FullScreenImageViewer
...
fun ChatScreen(viewModel: ChatViewModel, isCallActive: Boolean = false) {
    ...
    var selectedMessageForSheet by remember { mutableStateOf<SignaloutMessage?>(null) }
    ...
    val displayMessages = when {
        currentChannel != null -> channelMessages[currentChannel] ?: emptyList()
            ...
            if (locationChannel is com.signalout.android.geohash.ChannelID.Location) {
    ...
    val showMediaButtons = when {
        ...
        else -> selectedLocationChannel !is com.signalout.android.geohash.ChannelID.Location
    }
        ...
        Column(
            ...
            MessagesList(
                ...
                onNicknameClick = { fullSenderName ->
                    ...
                    val mentionText = if (selectedLocationChannel is com.signalout.android.geohash.ChannelID.Location && hashSuffix.isNotEmpty()) {
    ...
    androidx.compose.runtime.LaunchedEffect(Unit) {
        com.signalout.android.ui.events.FileShareDispatcher.setHandler { peer, channel, path ->
    ...
    if (!isCallActive) {
        ...
        AnimatedVisibility(
            ...
            Surface(
                ...
                border = BorderStroke(2.dp, WhatsAppColors.TealAccent)
            ) {
                IconButton(onClick = { forceScrollToBottom = !forceScrollToBottom }) {
                    Icon(
                        imageVector = Icons.Filled.ArrowDownward,
                        contentDescription = stringResource(com.signalout.android.R.string.cd_scroll_to_bottom),
...
private fun ChatFloatingHeader(
    ...
    val locationManager = remember { com.signalout.android.geohash.LocationChannelManager.getInstance(context) }
...
private fun ChatDialogs(
    ...
    selectedMessageForSheet: SignaloutMessage?,
    viewModel: ChatViewModel,

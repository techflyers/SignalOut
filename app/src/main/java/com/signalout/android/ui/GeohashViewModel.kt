...
import com.signalout.android.nostr.GeohashMessageHandler
import com.signalout.android.nostr.GeohashRepository
import com.signalout.android.nostr.NostrDirectMessageHandler
import com.signalout.android.nostr.NostrIdentityBridge
import com.signalout.android.nostr.NostrProtocol
import com.signalout.android.nostr.NostrRelayManager
import com.signalout.android.nostr.NostrSubscriptionManager
...
class GeohashViewModel(
    ...
    private var locationChannelManager: com.signalout.android.geohash.LocationChannelManager? = null
    ...
    fun initialize() {
        ...
        try {
            locationChannelManager = com.signalout.android.geohash.LocationChannelManager.getInstance(getApplication())
            ...
            state.setSelectedLocationChannel(com.signalout.android.geohash.ChannelID.Mesh)
    ...
    fun sendGeohashMessage(content: String, channel: com.signalout.android.geohash.GeohashChannel, myPeerID: String, nickname: String?) {
        viewModelScope.launch {
            try {
                ...
                val localMsg = com.signalout.android.model.SignaloutMessage(
                    id = tempId,
                ...
                if (startedMining) {
                    com.signalout.android.ui.PoWMiningTracker.startMiningMessage(tempId)
                }
                try {
                    ...
                    if (startedMining) {
                        com.signalout.android.ui.PoWMiningTracker.stopMiningMessage(tempId)
                    }
                }
            } catch (e: Exception) {
    ...
    fun startGeohashDM(pubkeyHex: String, onStartPrivateChat: (String) -> Unit) {
        ...
        val gh = (current as? com.signalout.android.geohash.ChannelID.Location)?.channel?.geohash
        if (!gh.isNullOrEmpty()) {
    ...
    fun blockUserInGeohash(targetNickname: String) {
        ...
        if (pubkey != null) {
            ...
            val sysMsg = com.signalout.android.model.SignaloutMessage(
                sender = "system",
    ...
    private fun switchLocationChannel(channel: com.signalout.android.geohash.ChannelID?) {

...
object NotificationTextUtils {
     ...
     */
    fun buildPrivateMessagePreview(message: SignaloutMessage): String {
        return try {
            when (message.type) {
                SignaloutMessageType.Image -> "📷 sent an image"
                SignaloutMessageType.Audio -> "🎤 sent a voice message"
                SignaloutMessageType.File -> {

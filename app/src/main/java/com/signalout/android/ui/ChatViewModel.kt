...
import com.signalout.android.favorites.FavoritesPersistenceService
import kotlinx.coroutines.flow.StateFlow
import com.signalout.android.mesh.BluetoothMeshDelegate
import com.signalout.android.mesh.BluetoothMeshService
import com.signalout.android.service.MeshServiceHolder
import com.signalout.android.model.SignaloutMessage
import com.signalout.android.nostr.NostrIdentityBridge


import kotlinx.coroutines.launch
import com.signalout.android.util.NotificationIntervalManager
import kotlinx.coroutines.delay
import java.util.Date
import kotlin.random.Random
import com.signalout.android.services.VerificationService
import com.signalout.android.identity.SecureIdentityStateManager
import com.signalout.android.noise.NoiseSession
import com.signalout.android.util.hexEncodedString

/**
 * Refactored ChatViewModel - Main coordinator for signalout functionality
...
class ChatViewModel(
    ...
    val messages: StateFlow<List<SignaloutMessage>> = state.messages
    ...
    val isPeerTyping: StateFlow<Boolean> = state.isPeerTyping
    val typingUsers: StateFlow<List<String>> = state.typingUsers
    val privateChats: StateFlow<Map<String, List<SignaloutMessage>>> = state.privateChats
    ...
    val channelMessages: StateFlow<Map<String, List<SignaloutMessage>>> = state.channelMessages
    ...
    init {
        ...
        viewModelScope.launch {
            try { com.signalout.android.services.AppStateStore.peers.collect { peers ->
                state.setConnectedPeers(peers)
                state.setIsConnected(peers.isNotEmpty())
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.signalout.android.services.AppStateStore.publicMessages.collect { msgs ->
                // Source of truth is AppStateStore; replace to avoid duplicate keys in LazyColumn
                state.setMessages(msgs)
            } } catch (_: Exception) { }
        }
        viewModelScope.launch {
            try { com.signalout.android.services.AppStateStore.privateMessages.collect { byPeer ->
                ...
                try {
                    val seen = com.signalout.android.services.SeenMessageStore.getInstance(getApplication())
        ...
        viewModelScope.launch {
            try { com.signalout.android.services.AppStateStore.channelMessages.collect { byChannel ->
                // Replace with store snapshot
        ...
        viewModelScope.launch {
            com.signalout.android.mesh.TransferProgressManager.events.collect { evt ->
    ...
    private fun loadAndInitialize() {
        ...
        viewModelScope.launch {
            com.signalout.android.ui.debug.DebugSettingsManager.getInstance().debugMessages.collect { msgs ->
                if (com.signalout.android.ui.debug.DebugSettingsManager.getInstance().verboseLoggingEnabled.value) {
                    ...
                    if (selectedLocation is com.signalout.android.geohash.ChannelID.Mesh) {
        ...
        com.signalout.android.favorites.FavoritesPersistenceService.initialize(getApplication())
        ...
        try {
            val nostrTransport = com.signalout.android.nostr.NostrTransport.getInstance(getApplication())
    ...
    private fun ensureGeohashDMSubscriptionIfNeeded(convKey: String) {
        try {
            ...
            val repo = repoField.get(geohashViewModel) as com.signalout.android.nostr.GeohashRepository
            ...
            if (!gh.isNullOrEmpty()) {
                ...
                val subMgr = subMgrField.get(geohashViewModel) as com.signalout.android.nostr.NostrSubscriptionManager
                val identity = com.signalout.android.nostr.NostrIdentityBridge.deriveIdentity(gh, getApplication())
                val subId = "geo-dm-$gh"
                ...
                if (currentId != subId) {
                    ...
                    subMgr.subscribeGiftWraps(
                        ...
                        handler = { event ->
                            ...
                            val dmHandler = dmHandlerField.get(geohashViewModel) as com.signalout.android.nostr.NostrDirectMessageHandler
    ...
    fun openLatestUnreadPrivateChat() {
        try {
            ...
            val openPeer: String = if (targetKey.startsWith("nostr_")) {
                ...
                val canonical = com.signalout.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
                    ...
                    nostrPubHexForAlias = { alias -> com.signalout.android.nostr.GeohashAliasRegistry.get(alias) },
                    findNoiseKeyForNostr = { key -> com.signalout.android.favorites.FavoritesPersistenceService.shared.findNoiseKey(key) }
                )
                canonical ?: targetKey
            }
    ...
    fun sendMessage(content: String) {
        ...
        if (content.startsWith("/")) {
            ...
            commandProcessor.processCommand(content, meshService, meshService.myPeerID, { messageContent, mentions, channel ->
                if (selectedLocationForCommand is com.signalout.android.geohash.ChannelID.Location) {
        ...
        if (selectedPeer != null) {
            ...
            selectedPeer = com.signalout.android.services.ConversationAliasResolver.resolveCanonicalPeerID(
            ...
            privateChatManager.sendPrivateMessage(
                ...
                val router = com.signalout.android.services.MessageRouter.getInstance(getApplication(), meshService)
                router.sendPrivate(messageContent, peerID, recipientNicknameParam, messageId)
            }
        } else {
            // Check if we're in a location channel
            val selectedLocationChannel = state.selectedLocationChannel.value
            if (selectedLocationChannel is com.signalout.android.geohash.ChannelID.Location) {
    ...
    fun toggleFavorite(peerID: String) {
        ...
        try {
            ...
            if (peerInfo?.noisePublicKey != null) {
                ...
                if (peerID.length == 64 && peerID.matches(Regex("^[0-9a-fA-F]+$"))) {
                    try {
                        ...
                        val rel = com.signalout.android.favorites.FavoritesPersistenceService.shared.getFavoriteStatus(noiseKey!!)
            ...
            if (noiseKey != null) {
                ...
                val identityManager = com.signalout.android.identity.SecureIdentityStateManager(getApplication())
                ...
                com.signalout.android.favorites.FavoritesPersistenceService.shared.updateFavoriteStatus(
                ...
                try {
                    val myNostr = com.signalout.android.nostr.NostrIdentityBridge.getCurrentNostrIdentity(getApplication())
    ...
    private fun updateReactiveStates() {
        ...
        sessionStates.forEach { (peerID, newState) ->
            ...
            if (old != "established" && newState == "established") {
                com.signalout.android.services.MessageRouter
    ...
    override fun didReceiveMessage(message: SignaloutMessage) {
    ...
    fun panicClearAllData() {
        ...
        try {
            com.signalout.android.services.SeenMessageStore.getInstance(getApplication()).clear()
        } catch (_: Exception) { }
        ...
        com.signalout.android.features.file.FileUtils.clearAllMedia(getApplication())
        ...
        try {
            ...
            try {
                val store = com.signalout.android.geohash.GeohashBookmarksStore.getInstance(getApplication())
                store.clearAll()
            } catch (_: Exception) { }
    ...
    fun selectLocationChannel(channel: com.signalout.android.geohash.ChannelID) {
